...
clean: clean_greet clean_calculator clean_pow clean_blog ## Clean generated files
	${RM_F_CMD} ssl/*.crt
	${RM_F_CMD} ssl/*.csr
	${RM_F_CMD} ssl/*.key
	${RM_F_CMD} ssl/*.pem
...
clean_pow: ## Clean generated files for pow
	${RM_F_CMD} pow/${PROTO_DIR}/*.pb.go
